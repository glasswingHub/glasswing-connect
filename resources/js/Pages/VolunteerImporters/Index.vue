                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                <template v-if="!importer.deleted_at">
                                    <Link :href="route('volunteer_importers.show', importer.id)" class="text-blue-600 hover:text-blue-900">
                                        Ver
                                    </Link>
                                    <Link :href="route('volunteer_importers.edit', importer.id)" class="text-indigo-600 hover:text-indigo-900">
                                        Editar
                                    </Link>
                                    <button
                                        @click="$inertia.delete(route('volunteer_importers.destroy', importer.id))"
                                ...
                                <template v-else>
                                    ...
                                    <button
                                        @click="$inertia.patch(route('volunteer_importers.restore', importer.id))"
                                    ...
                                    <button
                                        @click="$inertia.delete(route('volunteer_importers.force-delete', importer.id))"
                                        class="text-red-600 hover:text-red-900"
