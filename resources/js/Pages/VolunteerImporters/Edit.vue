...
const submit = () => {
    form.put(route('volunteer_importers.update', props.importer.id));
};

const pageActions = [
    {
        href: route('volunteer_importers.show', props.importer.id),
        label: 'Ver detalle'
    },
    {
        ...
        <form @submit.prevent="submit">
            ...
            <div v-if="form.source_table" class="mt-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">
                    Columnas de la tabla origen: <span class="font-bold">{{ form.source_table }}</span>
                </h3>
